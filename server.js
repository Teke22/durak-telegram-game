...
const getAppUrl = () => {
  ...
  // Railway/Fly/др. — можно добавить свои переменные тут
...
function initBot() {
  ...
  // На проде — webhook; локально можно временно включать polling
  ...
  if (!usePolling) {
    // Webhook режим — настроим, когда сервер поднимется и будет известен порт/URL
...
// Ручная установка вебхука (иногда полезно на Render, если старт прошёл раньше чем появился RENDER_EXTERNAL_URL)
